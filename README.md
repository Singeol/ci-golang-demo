...
Все команды запуска задач в проекте объединены в Makefile. Вот какие действия можно совершать:
...
Расширяем задание 4 следующими задачами:
...
Расширяем задание 5 следующими задачами:

- При тэгировании коммита загружать готовый docker-образ только с тегом
- При коммите без тэга загружать готовый docker-образ только с sha коммита